...
resource "azuread_conditional_access_policy" "CP01" {
  display_name = "CP01-Block-LegacyAuthentication-AllAps-Everywherev4"
  state        = "enabled"
...
resource "azuread_conditional_access_policy" "CP04" {
  display_name = "CP03-Require-MFAAUthenticationforeveryone-AllAps-Everywherev333"
  state        = "enabledForReportingButNotEnforced"
